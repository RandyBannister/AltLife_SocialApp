...
- (void)setupView
{
	...
	// Table View
    CGRect tableFrame = CGRectMake(0.0f, 71.0f, self.view.frame.size.width, self.view.frame.size.height - kInputHeight-71);
    ...
    self.imageInput = [[UIImageView alloc] init];//initWithImage:self.options[AMOptionsImageBar]];
    [self.imageInput setBackgroundColor:[UIColor colorWithRed:244.0f/255.0f green:244.0f/255.0f blue:244.0f/255.0f alpha:1.0f]];
    ...
    self.textView = [[UITextView alloc] initWithFrame:CGRectMake(15.0f, 10.0f, width-12, kLineHeight)];
...
//    self.buttonSend.titleLabel.shadowOffset = CGSizeMake(0.0f, -1.0f);
    ...
    [self.buttonSend setTitleColor:[UIColor colorWithRed:90.0f/255.0f green:90.0f/255.0f blue:90.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
    ...
    [self.buttonSend setTitleColor:[UIColor colorWithRed:200.0f/255.0f green:200.0f/255.0f blue:200.0f/255.0f alpha:1.0f] forState:UIControlStateDisabled];
    
    [self.buttonSend setEnabled:NO];
    [self.buttonSend setFrame:CGRectMake(self.imageInput.frame.size.width - 65.0f, [self.options[AMOptionsButtonOffset] floatValue]+10, 59.0f, 26.0f)];
...
#pragma GCC diagnostic pop
    ...
    return MAX(size.height + 70.0f + usernameSize.height,
